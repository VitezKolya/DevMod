...
public class PacketTileUpdate extends PacketANT {
	...
	public PacketTileUpdate(int x, int y, int z, ForgeDirection orientation, byte state,
			String customName) {
	...
	public void execute(INetworkManager manager, Player player) {
		...
		DevMod.proxy.handleTileEntityPacket(x, y, z,
